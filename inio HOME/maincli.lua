return function(driveTable)
    ...
    for i,v in pairs(driveTable) do
        if v["port filled?"] == false then
            driveTable[i] = nil
            table.insert(driveInputs, i)
        end
    end
